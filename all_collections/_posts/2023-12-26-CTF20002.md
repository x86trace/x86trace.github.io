...
![](/run/user/1000/doc/8e522cc9/port80.png)
...
![](/run/user/1000/doc/5b9dcc36/addingmagicbytes.png)

as you can see we get the file uploaded successfully

![](/run/user/1000/doc/f281a12b/fileuploadedsucsessful.png)

and once we visit `/upload/rev.php` we get the shell.

![](/run/user/1000/doc/519ad1fc/gotrevshell.png)

## PrivEsc:

Running LinPEAS gave me this strange SUID at `/opt` named as *fileS*

![](/run/user/1000/doc/2e611ca6/foundaninterestingbinary.png)
...
![](/run/user/1000/doc/7a0937ed/itsFINDBINARY.png)
...
![](/run/user/1000/doc/698e69af/rooted.png)
